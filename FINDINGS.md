...
⚠ **CORRECTED 2026-09-01 — the ms-per-foot figure only. THE FINDING'S CONCLUSION IS UNCHANGED.** This entry gives 7.18 ms per foot (1 ft ÷ release speed, 139.33 ft/s) and notes "with in-flight drag at a ~91 mph flight average the true figure is ~7.5 ms." **Both are the wrong quantity.** Releasing one foot closer to the plate does not re-price the whole trajectory at an average speed: the ball leaves the hand at the same speed and follows the same speed-vs-distance profile, so what disappears is the **final** foot of flight — the foot the ball would have covered **at its slowest, ~87 mph**. **Correct figure: 1 ft ÷ 127.7 ft/s = 7.83 ms per foot at a 95 mph release** (independently reproduced by the in-house drag model in F-252). The change is +9% and **alters nothing** — the scale-bar argument (1 ft ≈ 2.2 SD ≈ the whole major-league range) and the total absence of any extension intervention both stand. Logged because the *reasoning* error — pricing a marginal change at an average rate when the change is removed from one tail of the distribution — is a recurring one (cf. F-072, F-248). See F-252 and `daily/2026-09-01-hitter-perception.md` §3.3.
...
# 17 — HITTER PERCEPTION AND THE TIMING BUDGET

*Added 2026-09-01. **VERIFICATION WARNING FOR THIS ENTIRE SECTION:** all external fetch (WebFetch and curl alike) was blocked by the network proxy on 2026-09-01, including every domain the run instructions listed as working. **Every empirical magnitude in F-251, F-254, F-255, F-256, F-257 and F-258 is SNIPPET-LEVEL and has NOT been read at source.** Paper existence is corroborated by PMID/DOI recurring across independent search result sets; magnitudes are not verified. F-252 and F-253 are in-house arithmetic and are independent of that failure. See F-259.*

### F-251 | THE HITTER'S TIMING BUDGET — the acceptable timing error at ball-bat impact is ~±8 ms, and it varies TWELVE-FOLD across hitters
TOPIC: hitter perception, timing error, ball-bat impact, sweet spot, window, swing path, budget, collegiate, snippet-only
CLAIM: The window in which a hitter can meet the ball on the sweet spot is on the order of ±8 ms on a fastball — but the across-hitter range is roughly 2.5 ms to 30 ms, and the width is set by the hitter's own swing path, not by the pitch.
NUMBERS: HUMAN MOVEMENT SCIENCE 2019 (PMID 31254808, DOI 10.1016/j.humov.2019.06.011, Shibaura Institute of Technology), n = 26 HIGH-SCHOOL batters, pitching machine, optical mocap of ball/bat/pelvis: acceptable timing error FASTBALL ±7.9 ms, CURVEBALL ±10.7 ms, "SLOWBALL" ±10.7 ms; optimal timing for OUTSIDE pitches ~10 ms LATER than for inside. — FRONTIERS IN SPORTS AND ACTIVE LIVING 2025 (PMID 40225202, PMC11985794), 18 pitched-ball trajectories from 10 COLLEGIATE pitchers x 145 swings from 29 COLLEGIATE batters, computationally recombined; MAX BALL SPEED 39.6 m/s = 88.6 mph: mean acceptable range 9.36 +/- 6.25 ms and 0.227 +/- 0.163 m; ACROSS-HITTER RANGE 2.48-30.40 ms (0.056-0.614 m). Determined by swing trajectory viewed from the side AND from above, plus bat angle at impact. ⚠ UNRESOLVED INTERNAL INCONSISTENCY: 0.227 m / 9.36 ms = 24.3 m/s = 54 mph, which is not reconcilable with a max ball speed of 39.6 m/s at any reading. Either one figure is a half-width and the other a full width, or they are measured along different axes. THIS IS A FACTOR OF TWO ON EVERY DOWNSTREAM CALCULATION and it cannot be resolved without the paper.
POPULATION: HIGH-SCHOOL batters (2019) — `SAMPLE MISMATCH — directional only`; COLLEGIATE pitchers and batters (2025), at ~88.6 mph, essentially AT the corpus floor. Note the population of interest here is the HITTER, i.e. the opponent, not the athlete being developed.
EVIDENCE: EMERGING — two independent samples, consistent order of magnitude; NEITHER READ AT SOURCE (see section warning)
CAUSALITY: CROSS_SECTIONAL (measurement of a geometric tolerance, not a manipulation)
SOURCE: Human Movement Science (2019), "Acceptable timing error at ball-bat impact for different pitches and its implications for baseball skills," PMID 31254808. Frontiers in Sports and Active Living (2025), "Acceptable range of timing error at bat-ball impact in baseball depends on the bat swing path," PMID 40225202 / PMC11985794. Both SNIPPET-LEVEL, 2026-09-01.
COACHING: DO NOT PUT A NUMBER ON A WHITEBOARD. Use the ORDERING, which survives the factor-of-two ambiguity: the hitter's whole allowance is small enough that a few mph of UNEXPECTED speed exhausts it. THE HEADLINE IS THE SPREAD, NOT THE MEAN — a twelve-fold range means the value of a millisecond taken from a hitter is NOT A CONSTANT. It is large against a steep, short-window swing and close to irrelevant against a flat, long-window one. This is the first quantity in the corpus that prices a pitcher's stuff AGAINST A NAMED OPPONENT rather than against a league. The outside-pitch result (+10 ms later) is the timing statement of a fact the corpus already holds spatially. CONVERSION: at plate speed ~87 mph, 1 ms of timing error ~ 1.5 inches of ball travel.
CONFIDENCE: low-medium — order of magnitude is probably right; the exact value is unverified and internally ambiguous
SEE ALSO: F-252, F-253, F-254, F-259, F-171

### F-252 | FLIGHT-TIME ARITHMETIC — 1 mph is worth ~4.3-4.8 ms, 1 foot of extension ~7.8-8.3 ms, and the per-mph return is LARGER at 90 than at 95
TOPIC: flight time, arithmetic, velocity, extension, milliseconds, sensitivity, drag, in-house, verified
CLAIM: Release-to-plate flight time and its sensitivities to velocity and extension, computed in-house with a stated drag model, put velocity and extension on one axis with the hitter's timing budget.
NUMBERS: MODEL: v(x) = v0 x exp(-kx), calibrated so a 95 mph release arrives ~87 mph over 54.0 ft => k = 0.001629 /ft (8.4% loss). Distance = 60.5 - extension. FLIGHT TIMES (ms) at 6.50 ft extension: 88 mph = 437.3; 90 = 427.6; 92 = 418.3; 95 = 405.1; 98 = 392.7. At 6.00 ft: 441.6 / 431.8 / 422.4 / 409.0 / 396.5. At 7.50 ft: 428.9 / 419.4 / 410.2 / 397.3 / 385.1. SENSITIVITIES at 95 mph / 6.5 ft: -4.31 ms per mph; -7.83 ms per FOOT of extension; -0.65 ms per INCH. At 90 mph / 6.3 ft: -4.82 ms per mph; -8.27 ms per foot. THE PER-MPH TIMING RETURN IS LARGER AT LOWER VELOCITY because flight time goes as 1/v. EXCHANGE RATE: 1 mph ~ 1.8 inches of extension in timing terms. Script preserved at daily/2026-09-01-hitter-perception.md 3.
POPULATION: population-independent (physics); calibration is MLB-typical drag
EVIDENCE: ESTABLISHED (arithmetic, computed in-house 2026-09-01, model and calibration stated in full)
CAUSALITY: MECHANISM
SOURCE: In-house computation 2026-09-01, daily/2026-09-01-hitter-perception.md 3.1-3.2. Drag calibration from the standard Statcast observation that a 95 mph release arrives at ~87 mph.
COACHING: THIS DOES NOT CREATE A LEVER; IT RE-DENOMINATES ONE. Say so out loud rather than selling a unit change as a discovery. What it buys: velocity, extension and velocity-separation become comparable on ONE axis. THE USEFUL CONSEQUENCE: at F-250's realistic individual extension change of 0.1-0.3 ft, extension is worth 0.8-2.4 ms = ROUGHLY A FIFTH OF A MPH. Extension is not a substitute for velocity at any achievable magnitude. THE OPEN QUESTION THIS EXPOSES: per-mph TIMING return RISES as velocity falls, while per-mph TRAINING return FALLS as baseline rises (F-025). Those two curves run opposite ways and nobody has priced them against each other — i.e. where in a roster is a mph worth the most?
CONFIDENCE: high — checkable by hand; the only fully verified content produced on 2026-09-01
SEE ALSO: F-250, F-251, F-253, F-025, F-150

### F-253 | VELOCITY SEPARATION SATURATES AT ~4 MPH — past that the pitch is already several windows late, and the binding constraint becomes recognition
TOPIC: changeup, velocity separation, offspeed, timing, saturation, disguise, recognition, arithmetic
CLAIM: Off a 92 mph fastball, a 3 mph velocity gap already makes the ball arrive later than the hitter's entire acceptable timing window; beyond ~4 mph, additional separation buys no further timing disruption, so the remaining variable is whether the hitter identifies the pitch.
NUMBERS: Computed in-house, same model as F-252, off a 92 mph fastball at fixed 6.5 ft extension. ARRIVAL DELAY: 2 mph gap = 9.3 ms; 3 mph = 14.1 ms; 4 mph = 19.0 ms; 5 mph = 24.0 ms; 6 mph = 29.2 ms; 8 mph = 39.8 ms; 10 mph = 51.0 ms; 12 mph = 62.7 ms. Against a +/-8 ms allowance (F-251) that is 1.2 / 1.8 / 2.4 / 3.0 / 3.6 / 5.0 / 6.4 / 7.8 half-windows respectively.
POPULATION: population-independent arithmetic; the +/-8 ms denominator carries F-251's population caveats and its factor-of-two ambiguity
EVIDENCE: ESTABLISHED as arithmetic / EMERGING as a coaching conclusion (the denominator is unverified)
CAUSALITY: MECHANISM
SOURCE: In-house computation 2026-09-01, daily/2026-09-01-hitter-perception.md 3.4. Consistent with the CORRECTED changeup chain in F-232 (velocity GAP -> hitters out front -> whiffs), which this entry prices and shows the saturation point of.
COACHING: READ THE TABLE CORRECTLY OR NOT AT ALL. Following a cross-examination concession on 2026-09-01: the table is NOT "the effect of a velocity gap." It is THE PENALTY FOR A GIVEN ARRIVAL-TIME ESTIMATION ERROR. A hitter who correctly identifies the changeup RE-TIMES IT and the table becomes irrelevant. The table is the cost of being WRONG, not the cost of the pitch — and the distribution of hitters' estimation error by pitch type is UNMEASURED, searched for and not found. WITH THAT READ, THE COACHING CONCLUSION HOLDS: stop chasing velocity separation past ~4 mph. The margin is already saturated several times over, and separation past that point is PAID FOR in recognisability, because the kinematics that remove 10 mph are visible and the ones that remove 6 are not. TELL THE PITCHER: "stop trying to make the changeup slower; make it look the same." CHART arm-speed match, not velo gap. FAILURE ON VIDEO: throwing-arm deceleration pattern after release differing between the two pitches at 240 fps; front side opening earlier on the changeup. HOW YOU KNOW IT WORKED: you CANNOT check this in a bullpen — there is no hitter in it. Live at-bats charted for swing rate and contact timing (early/on/late) across >= 200 charted changeups, i.e. 8-12 outings.
CONFIDENCE: medium-high on the saturation, medium on the coaching conclusion, and the caveat is load-bearing
SEE ALSO: F-232, F-159, F-251, F-252, F-255

### F-254 | THE 150 MS COMMIT POINT HAS DIRECT EXPERIMENTAL SUPPORT — and the mechanism the industry cites for it is the WRONG ONE
TOPIC: commit point, occlusion, visuomotor delay, tunnel point, eye tracking, smooth pursuit, correction, F-163
CLAIM: An occlusion experiment independently supports the claim that the final ~150 ms of ball flight adds nothing to hitting accuracy — so F-163 under-credited the 150 ms figure — but the rationale Baseball Prospectus gave for it (an angular eye-velocity limit) is a different constraint and is contradicted by the very source it traces to.
NUMBERS: HIGUCHI et al. (2016), PLoS ONE 11(2):e0148498, PMID 26848742 / PMC4743964. n = 10 COLLEGE position players, machine-launched ball. THREE CONDITIONS: R+150 (occluded from 150 ms AFTER release — sees only the first 150 ms); A-150 (occluded from 150 ms BEFORE arrival — sees everything EXCEPT the last 150 ms); NO (no occlusion). RESULTS: occlusion did NOT shift the MEAN contact location in the bat long axis, short axis, or pitcher-catcher direction. Standardized VARIABILITY fell from R+150 to A-150 in the bat SHORT-AXIS direction only, and A-150 did NOT differ from NO. Authors: the limitation on useful visual information is the LATER part of the trajectory, "likely due to visuo-motor delay." MACHINE BALL SPEED NOT STATED IN ANY AVAILABLE SUMMARY. — BAHILL & LARITZ (1984), "Why can't batters keep their eyes on the ball?", American Scientist 72:249-253: a professional batter combining smooth pursuit up to ~120 deg/s with head rotation tracked the ball TO WITHIN ABOUT 5.5 FEET of the plate. At ~87 mph plate speed, 5.5 ft is roughly THE LAST 43 ms — not the last 150 ms. Batters also use a saccade to a predicted contact point, then let the ball catch up.
POPULATION: college position players (Higuchi); one professional plus amateurs (Bahill & LaRitz). Hitters, i.e. the opponent.
EVIDENCE: EMERGING (Higuchi n = 10, snippet-level) — but it UPGRADES F-163's 150 ms figure from an unexamined industry assertion to a claim with independent experimental support
CAUSALITY: MANIPULATED (vision was experimentally occluded) — but on HITTERS, and the outcome is hitting accuracy, not a pitching variable
SOURCE: Higuchi T et al. (2016), PLoS ONE 11(2):e0148498. Bahill AT & LaRitz T (1984), American Scientist 72:249-253. Both SNIPPET-LEVEL 2026-09-01.
COACHING: TWO CONSTRAINTS THAT THE INDUSTRY FUSES AND THAT MUST BE KEPT APART. (1) THE OCULOMOTOR LIMIT — can the eye follow the ball? Bahill says a professional followed it to 5.5 ft, so this limit binds LATE and weakly. (2) THE VISUOMOTOR LIMIT — can information still CHANGE the swing? Higuchi says no, from about 150 ms out. THE SECOND IS THE LOAD-BEARING ONE and BP cited the first. WHY THE DISTINCTION CHANGES PITCH DESIGN: if the limit were oculomotor, "see it longer" would be trainable and worth attacking. Because it is visuomotor delay, LATE MOVEMENT DOES NOT BEAT THE HITTER BY HIDING FROM HIS EYES — IT BEATS HIM BY ARRIVING AFTER HIS SWING IS COMMITTED. NOTE THE DIRECTION OF THIS CORRECTION: it moves the corpus toward MORE confidence in a number, which is the opposite direction from all six corrections in F-240, and is therefore worth a second look when a source can be read.
CONFIDENCE: medium — the ordering and the distinction are solid; every magnitude is unverified
SEE ALSO: F-163, F-251, F-255, F-240, F-259

### F-255 | THE HITTER SOLVES TIMING FIRST AND LOCATION LAST — so "deception" is TWO attacks, not one
TOPIC: hitter perception, timing, swing decision, trajectory adjustment, temporal structure, VR, professional, taxonomy
CLAIM: In a VR batting task with professional hitters, occluding late ball flight left swing-TIMING adjustment unaffected, degraded swing DECISION slightly, and significantly degraded swing-TRAJECTORY adjustment — implying the brain computes timing first, then the swing/take decision, then trajectory.
NUMBERS: SAIJO N, FUKUDA S, KASHINO M (2025), "The temporal structure of multiple visuomotor processes in baseball batting: insights from a virtual reality system," Frontiers in Psychology 16:1514301 (PMC11822940). NTT Communication Science Laboratories. n = 23 BATTERS FROM A JAPANESE PROFESSIONAL TEAM — the only genuinely elite hitter sample located this cycle. Batters demonstrably adjusted swing timing to pitch speed, made strike/ball swing decisions, and adjusted swing trajectory to plate location. UNDER OCCLUSION: swing timing adjustment UNAFFECTED; swing decision MINOR decline; swing trajectory adjustment SIGNIFICANT decline. NO EFFECT SIZES OR MS BOUNDARIES AVAILABLE FROM ANY SUMMARY. — CORROBORATING, DIFFERENT LAB: Ranganathan & Carlton (2007), J Motor Behav 39(5):369-380, PMID 17827114, 10 expert + 10 novice batters, VE fastball/changeup discrimination, 6 visual conditions: skilled batters' STEPPING patterns tracked the PITCHER'S KINEMATICS while their SWING TIME tracked BALL SPEED — the same early-body / late-ball dissociation. Also: batters were MORE accurate at naming the pitch when they did NOT have to swing (uncoupled > coupled).
POPULATION: Japanese professional batters (Saijo); expert/novice batters (Ranganathan & Carlton). Hitters.
EVIDENCE: EMERGING — one VR study, one lab, n = 23, no replication; snippet-level
CAUSALITY: MANIPULATED (occlusion) — on hitters
SOURCE: Saijo N, Fukuda S, Kashino M (2025), Front Psychol 16:1514301. Ranganathan R & Carlton LG (2007), J Mot Behav 39(5):369-380, PMID 17827114. Both SNIPPET-LEVEL 2026-09-01.
COACHING: USE THIS AS A TAXONOMY, NOT A DRILL. It changes no activity; it stops the corpus calling two different things "deception." TIMING ATTACK — lives BEFORE and IMMEDIATELY AFTER release: delivery, release consistency between pitch types, anything that makes speed unpredictable at the release instant. Measured by HRA overlap from Trackman across ~100 pitches of each type (F-164's existing protocol). TRAJECTORY ATTACK — lives in LATE MOVEMENT, the part of flight the hitter is still trying to use and least able to. TELL THE PITCHER: "he decides how fast before he decides where. What beats him early is speed he didn't expect; what beats him late is movement." FAILURE ON VIDEO: visibly different arm slot or release height between fastball and breaking ball on overlaid 240 fps frames at release. THE ANATOMIST'S MECHANISM, WHICH IS WHY THE ORDERING IS PLAUSIBLE AT ALL: timing needs one cheap scalar (time-to-contact from optical expansion); trajectory adjustment needs a continuously updated effector vector. "Cheap scalar first, expensive vector last" is what the physiology predicts. WHAT THE ANATOMIST WILL NOT CONCEDE: the BOUNDARIES. Whether the decision closes at 150, 180 or 220 ms depends on conduction plus electromechanical delay plus swing duration, which vary 40-80 ms across athletes. NOBODY HAS MEASURED A COMMIT POINT IN AN INDIVIDUAL HITTER. Higuchi's 150 ms is an experimenter-chosen occlusion boundary, not a measured commit point.
CONFIDENCE: low-medium — a taxonomy is a much cheaper thing to be wrong about than a drill, which is the only reason it is being used at all
SEE ALSO: F-254, F-164, F-163, F-253, dispute #17

### F-256 | PITCH RECOGNITION IS TRAINABLE IN THE OPPONENT — deception is a depreciating asset and velocity is not
TOPIC: hitter perception, VR training, adaptive training, transfer, RCT, deception, depreciation, opponent
CLAIM: A randomised four-arm trial found adaptive VR batting training transferred to real batting and to competitive outcomes — meaning any pitching edge that works because the hitter cannot identify the pitch erodes as recognition training spreads, while an edge that works because the pitch is hard to intercept once identified does not.
NUMBERS: GRAY R (2017), "Transfer of Training from Virtual to Real Baseball Batting," Frontiers in Psychology 8:2183 (PMC5733365). n = 80 male competitive HIGH-SCHOOL batters, RANDOMISED to four groups: (1) ADAPTIVE training in a batting virtual environment, with performance-based staircase adjustment of pitch speed, location and spin rate; (2) extra VE batting practice; (3) extra on-field real batting practice; (4) no-training control. RESULT: the adaptive group's pre-to-post improvement was significantly greater than all three other groups; that group had superior batting statistics in league play; and a significantly greater proportion of that group reached a level of competition ABOVE high school. Proposed mechanism: greater sensitivity to ball-flight visual information, and improved use of LACE ROTATION to recognise pitch type. NO EFFECT SIZES AVAILABLE FROM ANY SUMMARY.
POPULATION: competitive HIGH-SCHOOL batters — `SAMPLE MISMATCH — directional only`, and expect a smaller effect in a lineup that already recognises well
EVIDENCE: EMERGING (one RCT, one lab, HS sample, snippet-level) — but note the DESIGN
CAUSALITY: INTERVENTION — randomised, four arms, with a real-world transfer test
SOURCE: Gray R (2017), Front Psychol 8:2183, PMC5733365. SNIPPET-LEVEL 2026-09-01.
COACHING: THE RULE THIS PRODUCES, WHICH IS THE MOST PORTABLE THING IN THE CYCLE. TWO CLASSES OF PITCHING EDGE. (A) ERODIBLE — works because the hitter cannot tell what is coming: tunnels, grip disguise, arm-speed matching. (B) NOT ERODIBLE — works because the pitch is physically difficult to intercept once CORRECTLY identified: velocity, late movement, location. PRIORITY ORDER THAT FOLLOWS: velocity capacity first, then late shape, then disguise. TELL THE PITCHER: "you can't out-hide a good hitter forever. You can out-run him." FAILURE ON VIDEO: a pitcher whose whole plan is trickery collapsing the third time through the order. HOW YOU KNOW: third-time-through performance within one season, >= 150 batters faced in the third pass — for a Friday starter that is most of a year. THIS IS A SLOW CHECK AND IT SHOULD BE PRESENTED AS ONE. THE METHODOLOGICAL POINT, WHICH IS EMBARRASSING AND SHOULD BE SAID PLAINLY: this is a four-arm RCT with a real transfer test, and the pitching-development literature this corpus covers contains NOTHING of that design at ANY level, let alone at 85+ (F-023, F-038).
CONFIDENCE: medium on the existence of transfer; high on the erodible/not-erodible taxonomy, which does not depend on the effect size
SEE ALSO: F-255, F-163, F-164, F-023, F-038

### F-257 | FIELD 2026-09-01 — the ABS challenge system is live in MLB, and at least one widely circulating effect figure is not credible
TOPIC: field sweep, ABS, automated ball-strike, challenge system, rule change, strike zone, command, edges, marketing, unverified
CLAIM: MLB adopted the ABS challenge system for 2026 with a rectangular height-scaled zone; the direction of the incentive change is real and matters for command development, but the effect sizes circulating in 2026 in-season coverage are unreliable and one is implausible on its face.
NUMBERS: ZONE DEFINITION (consistently reported across mlb.com, AP/NPR, CBS, Baseball America): a two-dimensional rectangle at the MIDDLE of home plate, 17 inches wide, TOP at 53.5% and BOTTOM at 27% of the batter's height. REPORTED COMPARISON TO THE UMPIRE ZONE, SECONDARY SOURCES ONLY: umpire zone more rounded and more pitcher-lenient, top ~55.6% and bottom ~24.2%; at 2-2 counts the umpire zone measured 449 sq in vs 443 sq in for ABS. REPORTED CONSEQUENCES, ALL SECONDARY AND UNQUANTIFIED: walk rates up early in 2026; edge-dependent pitchers and elite-framing batteries losing value; pitchers who locate IN the zone favoured over those who nibble. ⚠ REJECTED FIGURE: a fantasy-baseball piece claims hitters are chasing "40.2 percent this season, way up from 28.2 percent a season ago." A 12-POINT ONE-SEASON JUMP IN LEAGUE-WIDE CHASE RATE IS NOT A PLAUSIBLE MAGNITUDE — MLB chase has sat in the high-20s to low-30s for a decade. Almost certainly a mis-scoped or mislabelled split. DO NOT IMPORT.
POPULATION: MLB
EVIDENCE: ESTABLISHED (that the rule exists and its zone definition) / UNVERIFIED and partly NOT CREDIBLE (every effect size)
CAUSALITY: n/a — a rule change, i.e. a natural experiment nobody has yet analysed properly
SOURCE: MLB press release and mlb.com (2026); AP/NPR (23 Sep 2025); CBS Sports; Baseball America, "11 Things To Know About MLB's New ABS Challenge System For 2026"; Baseball-Reference ABS challenge tracker. All SNIPPET-LEVEL 2026-09-01. Rejected figure: an uncredited fantasy-baseball column.
COACHING: WHY A COLLEGE COACH CARES ABOUT AN MLB RULE — the NCAA has been trialling ABS, and the DIRECTION OF THE INCENTIVE CHANGE is the transferable part. IF THE CORNERS STOP BEING NEGOTIABLE, the value of a pitch that "just misses" falls and the value of an in-zone pitch that misses bats rises. That is a re-weighting of STUFF over NIBBLING, and it is the first development in two years that argues a pitching program should move its command target from the black toward the shadow-in. WHAT WOULD MAKE THIS ACTIONABLE RATHER THAN DIRECTIONAL: an ABS-era analysis of location run value by zone band, which does not exist yet — everything available is in-season blogging. WATCH ITEM. Do NOT quote any effect size from this entry.
CONFIDENCE: high that the rule and zone definition are as stated; low on everything downstream
SEE ALSO: F-169, F-170, F-182, F-258

### F-258 | FIELD 2026-09-01 — Driveline's IZT biomechanics-and-command correlations are UNDERPOWERED; neither reported coefficient reaches significance
TOPIC: field sweep, Driveline, Intended Zone Tracker, command, miss distance, markerless, underpowered, n=16, SABR
CLAIM: The biomechanical correlates of command reported from Driveline's Intended Zone Tracker plus markerless motion capture are based on n = 16 pitchers, and at that sample size neither reported correlation is statistically distinguishable from zero.
NUMBERS: Reported (2025 SABR Analytics Conference research presentations; Driveline, Feb 2026, "The Interaction of Biomechanics and Command"): biomechanical data from n = 16 PITCHERS via markerless motion capture, each pitch's MISS DISTANCE from a projected intended target paired with the associated biomechanics. LEAD KNEE EXTENSION VELOCITY AT FOOT PLANT vs miss distance r = -0.37. MAXIMAL SHOULDER EXTERNAL ROTATION vs miss distance r = +0.44. THE ARITHMETIC THAT KILLS IT: at n = 16, df = 14, the two-tailed critical r at alpha = .05 is 0.497. r = 0.44 -> p ~ .09. r = -0.37 -> p ~ .16. NEITHER IS SIGNIFICANT. The 95% CI on r = 0.44 at n = 16 runs from roughly -0.07 to +0.77 — it excludes neither zero nor "enormous." ⚠ ALSO UNRESOLVED: the available description says "greater VARIABILITY in this motion may lead to less accurate outcomes" while the coefficient is stated against MER ITSELF. A mean and a within-pitcher SD are different variables and the summary conflates them.
POPULATION: not stated in any available summary — Driveline's pitcher population spans HS to professional; mean velocity NOT REPORTED
EVIDENCE: WEAK — underpowered, population unstated, variable definition ambiguous, snippet-level
CAUSALITY: CROSS_SECTIONAL
SOURCE: 2025 SABR Analytics Conference research presentations; Driveline Baseball (Feb 2026), "The Interaction of Biomechanics and Command" (already in the library bibliography). SNIPPET-LEVEL 2026-09-01 — drivelinebaseball.com is on this program's WebFetch blocklist and was unreachable.
COACHING: DO NOT COACH EITHER VARIABLE OFF THIS. VERDICT: UNPROVEN. These are hypothesis generators at n = 16. THE INSTRUMENT IS WORTH MORE THAN THE RESULT — a projected intended-target zone paired with per-pitch miss distance is the best objective command measurement in the industry, and it is the reason to pay attention to this line of work regardless of what these two coefficients turn out to be. Note also that MER appearing as a command correlate would put it in direct tension with its role as a velocity variable, which is exactly the kind of two-sided variable dispute #12 is about.
CONFIDENCE: high that the sample is too small to support the claims; the underlying coefficients may still be real
SEE ALSO: F-182, F-186, F-176, F-177, dispute #12

### F-259 | PROCESS 2026-09-01 — a full research cycle ran with ZERO source access, and shipped anyway with the whole brief flagged
TOPIC: process, verification, egress, network, snippet-only, backlog, epistemics, operating rule
CLAIM: On 2026-09-01 all external fetch was blocked at the network proxy, so the entire cycle's empirical content is snippet-level; the cycle was delivered with a blanket verification banner rather than either suppressed or silently promoted.
NUMBERS: BLOCKED via BOTH WebFetch and curl (proxy 403 on CONNECT), including every domain the run instructions listed as WORKING: pmc.ncbi.nlm.nih.gov, ncbi.nlm.nih.gov, frontiersin.org, sportrxiv.org, jstage.jst.go.jp, tandfonline.com, journals.sagepub.com, ijspt.scholasticahq.com, nature.com — plus journals.plos.org, arxiv.org, doi.org, europepmc.org, semanticscholar.org, mdpi.com, baseball.physics.illinois.edu. WebSearch was the ONLY working channel. AFFECTED: F-251, F-254, F-255, F-256, F-257, F-258 (all magnitudes). NOT AFFECTED: F-252, F-253 (in-house arithmetic), and the F-250 refinement (derivation, checkable by hand).
POPULATION: n/a
EVIDENCE: n/a (process finding)
CAUSALITY: MECHANISM
SOURCE: proxy status and per-domain probe results recorded 2026-09-01; daily/2026-09-01-hitter-perception.md verification banner.
COACHING: THE PRECEDENT SET, DELIBERATELY. This is the SECOND cycle in this corpus to run without source reads — 2026-08-19 was the first, and it was NOT flagged at the time, which is why 2026-08-20 had to exist as a verification pass and why two of its seven claims turned out to be misread. THE RULE ADOPTED: when source access fails, SHIP THE CYCLE WITH A BLANKET BANNER AND A NAMED BACKLOG ENTRY — do not suppress it, and do not let a single unlabelled sentence through. A snippet-level claim is a LEAD. VERIFICATION BACKLOG OPENED, in priority order: (1) PMID 31254808 and PMID 40225202 — resolve whether the acceptable timing error is a HALF-WIDTH or a FULL WIDTH, which is a factor of two on every number in F-253; (2) the 2025 paper's unreconciled 0.227 m / 9.36 ms = 54 mph internal inconsistency; (3) Higuchi 2016 (PMC4743964) — the machine ball speed, never stated in any summary, and the actual F and p values; (4) Saijo 2025 (PMC11822940) — effect sizes and the ms boundaries of the occlusion conditions; (5) Gray 2017 (PMC5733365) — effect sizes and the exact transfer measure; (6) the SABR/Driveline IZT presentation — whether the MER coefficient is a mean or a within-pitcher SD, and the sample's competition level and mean velocity. NOTE FOR THE VERIFIER: F-254 moves the corpus toward MORE confidence in a number, which is the OPPOSITE direction from all six corrections in F-240. That is unusual enough to deserve a second look rather than a relieved acceptance.
CONFIDENCE: high — this is a statement about what did and did not happen
SEE ALSO: F-240, F-242, F-245, F-251, F-254
