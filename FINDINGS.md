...
POPULATION: MLB
EVIDENCE: ESTABLISHED (own computation; independently reproduces Zahradnik 2020, n = 2,350 pitchers, R2 = 0.945 from extension and release height)
CAUSALITY: MECHANISM
...
### F-241 | WARNING — the daily briefs still contain the PRE-CORRECTION text
TOPIC: warning, daily briefs, uncorrected, snapshot, propagation, corpus hygiene
CLAIM: The corrections applied on 2026-08-13 were written into the library files but NOT back into the dated daily briefs, which still assert the superseded claims.
...
CAUSALITY: MECHANISM
SOURCE: cross-file comparison performed 2026-08-17
COACHING: THE DAILY BRIEFS ARE DATED SNAPSHOTS, NOT CURRENT REFERENCE. If a future cycle greps the corpus for a number and hits a daily file, it will re-import a corrected error. Read the library files (or this registry) for current state. This is a live re-import vector for exactly the failure mode described in F-240.
CONFIDENCE: high — verified by direct comparison
SEE ALSO: F-240, F-039, F-043, F-072, F-073, F-232
...
*End of registry. 244 entries. Numbering is stable — never reuse or renumber an F-ID. New findings append from F-245.*
