...
### F-304 | METHODOLOGICAL — SEVENTH consecutive fully egress-blocked cycle, now with the gateway naming its own denial
TOPIC: method, egress, network, run condition, verification queue, blocked cycle, tooling
CLAIM: A seventh consecutive cycle opened zero primary sources, and the proxy's status endpoint now logs the denial explicitly, removing the last ambiguity about where the block sits.
NUMBERS: 2026-09-04, -05, -06, -07, -08, -09, -10 — SEVEN consecutive fully blocked cycles, ZERO pages opened. This cycle: raw curl returned "CONNECT tunnel failed, response 403" for en.wikipedia.org (control), www.ncbi.nlm.nih.gov and www.frontiersin.org. WebFetch returned a NEW explicit error type, EGRESS_BLOCKED, naming the domain. The agent proxy's own /__agentproxy/status endpoint now returns recentRelayFailures entries reading kind: "connect_rejected", detail: "gateway answered 403 to CONNECT (policy denial or upstream failure)" with the host attached — WHERE ON 2026-09-06 IT REPORTED ZERO RELAY FAILURES. WebSearch works. Unread verification queue: 23 carried + 4 added = 27 items. Seven arithmetic-only cycles have produced ~60 findings, none checked against data.
POPULATION: not applicable — methodological
EVIDENCE: ESTABLISHED (directly observed, four independent channels this cycle)
CAUSALITY: not applicable
SOURCE: daily/2026-09-10-report.md §0. Proxy status endpoint output quoted verbatim in that section.
COACHING: THE DIAGNOSIS IS NOW UNAMBIGUOUS AND IT REQUIRES A HUMAN: an empty network allowlist in the remote execution environment. Not an outage, not a paywall, not a proxy fault, not topic-related — en.wikipedia.org is denied as a control. NO AMOUNT OF RETRYING OR DOMAIN-SWAPPING WILL MOVE IT. THE STANDING BRIEF'S "WORKING DOMAINS" LIST HAS NOW BEEN WRONG SEVEN TIMES AND MUST BE DELETED FROM THE PROMPT, not amended — replace it with "probe first; if blocked, close a gap with arithmetic." KEEP THE PROBE-BEFORE-CHOOSING RULE: it cost ninety seconds and again determined the whole shape of the cycle. THE NEXT CYCLE WITH WORKING EGRESS MUST SPEND ITSELF ENTIRELY ON THE 27-ITEM QUEUE AND OPEN NO NEW TOPIC — this instruction is now three cycles old and has never been executable.
CONFIDENCE: high
SEE ALSO: F-259, F-266, F-267, F-277, F-285, F-294

### F-305 | THE SHADOW ANNULUS IS LARGER IN AREA THAN THE STRIKE ZONE IT BORDERS
TOPIC: command, framing, shadow zone, strike zone, geometry, called strike, catcher, measurement
CLAIM: The band of borderline pitches in which the call is a decision rather than a fact is geometrically larger than the strike zone itself, at every plausible zone height.
NUMBERS: Ball diameter 2.9 in, plate width 17.0 in. A pitch is a strike if any part of the ball overlaps the zone, so the BALL CENTRE may sit up to 17.0/2 + 2.9/2 = 9.95 in from centre — effective strike width 19.90 in. Statcast's Shadow Zone runs one ball width inside the edge to one ball width outside: a band 5.8 in wide in ball-centre coordinates. AREAS: zone height 17.0 in -> effective strike area 396 in^2, shadow annulus 462 in^2, ratio 1.17. Height 19.5 in -> 446 in^2 vs 491 in^2, ratio 1.10. Height 22.0 in -> 496 in^2 vs 520 in^2, ratio 1.05. THE ANNULUS EXCEEDS THE ZONE BY 5-17% ACROSS THE WHOLE RANGE.
POPULATION: universal — rulebook geometry, level-independent
EVIDENCE: ESTABLISHED — closed-form geometry, re-derivable in five lines
CAUSALITY: MECHANISM
SOURCE: Derived in-cycle 2026-09-10 from rulebook plate width, ball diameter, and Statcast's stated Shadow Zone definition (one ball width either side of the edge). No source opened. daily/2026-09-10-report.md §3a.
COACHING: The borderline region is not a small correction band at the margin of the target — IT IS BIGGER THAN THE TARGET, and inside it someone other than the pitcher has a vote on the outcome. This is the geometric reason command cannot be evaluated by called strikes at low sample (F-307) and the reason framing exists as a job at all. ⚠️ AREA IS NOT PROBABILITY: pitch density is not uniform, so the SHARE OF ACTUAL PITCHES landing in the shadow is NOT 50% and is bracketed at 12-20% wherever it is used (F-307, F-314).
CONFIDENCE: high — pure geometry
SEE ALSO: F-306, F-307, F-171, F-182

### F-306 | THE FRAMING-TO-INCHES CONVERSION — ~14 percentage points of shadow-strike rate per inch of location
TOPIC: command, framing, catcher, inches, conversion, shadow zone, called strike, units
CLAIM: A framing advantage expressed in percentage points of shadow-strike rate can be converted into inches of pitch location, and doing so shrinks the entire framing industry to a fraction of one pitcher's own miss.
NUMBERS: Called-strike probability runs from near-1 at the inner edge of the shadow to near-0 at the outer edge across the 5.8 in band (F-305). Taking the transition as roughly linear: 0.10->0.90 gives 13.8 pp/inch; 0.15->0.85 gives 12.1 pp/inch; 0.05->0.95 gives 15.5 pp/inch. CONVERSION: ~12-16 pp per inch, so DIVIDE ANY FRAMING GAP IN pp BY ~14 TO READ IT IN INCHES. Applied ILLUSTRATIVELY to an unverified summary-level best-to-worst MLB framing gap of 18.7 pp: ~1.2-1.6 inches. COMPARE F-183: best command in MLB misses ~7 in; average MLB misses ~11-13 in. The entire best-to-worst spread in major-league catcher framing is therefore worth roughly ONE-FIFTH of a single average pitcher's miss.
POPULATION: MLB for the illustrative gap; the CONVERSION is level-independent geometry
EVIDENCE: ESTABLISHED for the conversion rate; the 18.7 pp input is UNVERIFIED / SUMMARY-LEVEL
CAUSALITY: MECHANISM
SOURCE: Derived in-cycle 2026-09-10. The 18.7 pp figure is summary-level from an unknown-standing domain (calledthird.com) and is used illustratively only. daily/2026-09-10-report.md §3b, §2c.
COACHING: THE FINDING IS STATED AS A CONVERSION RATE DELIBERATELY, SO THAT IT DOES NOT DEPEND ON THE UNVERIFIED GAP — whatever the true best-to-worst framing spread turns out to be, divide by ~14. FRAMING IS A LARGE NUMBER IN RUNS BECAUSE IT IS APPLIED TO ~1,600 PITCHES A YEAR (F-313). IT IS A TINY NUMBER IN INCHES. Both halves are true and they point opposite ways: for the CATCHER, an inch applied 1,600 times is a real job; for the PITCHER, the entire framing industry is fighting over a fifth of his own error bar. THERE IS NO VERSION OF THIS WHERE A PITCHER'S DEVELOPMENT PLAN SHOULD CONTAIN A FRAMING TERM. ⚠️ DO NOT REPEAT 18.7 pp — it is unverified.
CONFIDENCE: high for the conversion; nil for the illustrative gap
SEE ALSO: F-305, F-183, F-171, F-313

### F-307 | CALLED-STRIKE RATE CANNOT MEASURE A COLLEGE PITCHER'S COMMAND — the sample does not exist inside a career
TOPIC: command, measurement, detection, power, called strike, shadow zone, college, sample size, noise floor
CLAIM: The number of framable taken pitches a college starter generates in a season is roughly two orders of magnitude short of what is needed to detect even a large command change in called-strike terms.
NUMBERS: Shadow pitches are near coin flips by construction (p ~ 0.5). Two-proportion test, 80% power, alpha = .05 two-sided: detecting 2 pp needs 9,811 shadow takes PER GROUP (19,622 total); 3 pp needs 4,360 (8,721); 5 pp needs 1,570 (3,140); 7 pp needs 801 (1,602); 10 pp needs 392 (785). SUPPLY SIDE: a college starter throws ~1,200-1,800 pitches a season; at a 12-20% shadow-take share that is 144-360 shadow takes per season (central case 1,500 x 15% = 225). SEASONS REQUIRED: 5 pp = 14.0 seasons; 7 pp = 7.1 seasons. ROBUSTNESS: the most generous cell (360/season) against the most forgiving effect (7 pp) still needs 4.5 seasons; pushing the shadow share to 25% and the pitch count to 2,000 still needs over three seasons.
POPULATION: NCAA college starter, 85+ mph — and the problem WORSENS with selection (see COACHING)
EVIDENCE: ESTABLISHED — closed-form power calculation
CAUSALITY: not applicable — a detection limit, not an effect
SOURCE: Derived in-cycle 2026-09-10. Standard two-proportion power formula. No source opened. daily/2026-09-10-report.md §3d.
COACHING: DELETE THE CALLED-STRIKE-RATE COLUMN FROM THE STAFF REPORT, OR RENAME IT "catcher + umpire + noise." Any called-strike-based command number computed on your own staff — a spreadsheet column, a TrackMan report, an in-house strike-stealing metric — IS NOISE WEARING A DECIMAL POINT. This is NOT a "needs a bigger sample" problem: the sample does not exist inside a college career. THE CONCLUSION IS NOT SENSITIVE TO ANY INPUT — it survives the entire bracket on both the shadow share and the pitch count. ⚠️ RESTRICTION OF RANGE MAKES THIS WORSE AT HIGHER LEVELS, NOT BETTER: elite command populations cluster more tightly, so the gap shrinks while the shadow-take supply does not grow. THE 85+ POPULATION IS THE HARDEST ONE IN WHICH TO MEASURE COMMAND BY CALLED STRIKES. Measure the INPUT instead (F-310, and the protocol in daily/2026-09-10-report.md §5).
CONFIDENCE: high — arithmetic, and robust across every bracket
SEE ALSO: F-305, F-308, F-310, F-182, F-257, F-289, F-295

### F-308 | THE CATCHER-ASSIGNMENT ARTIFACT — on a two-catcher college staff it is the size of the entire real signal, AND IT IS BIAS, NOT NOISE
TOPIC: command, catcher, framing, confound, collinearity, bias, college, measurement, CSAA, mixed model
CLAIM: Because a college staff has two catchers and near-constant assignment shares, the catcher's framing is collinear with pitcher identity, producing a systematic artifact in any called-strike command metric that does not shrink with more innings.
NUMBERS: The measured called-strike-rate difference between two pitchers arising FROM THE CATCHER ALONE is artifact = (s_i - s_j) x delta_catcher, where s is each pitcher's share caught by catcher A and delta is the framing gap between the two catchers. delta = 3 pp: share differences of 0.2 / 0.5 / 0.8 give 0.60 / 1.50 / 2.40 pp. delta = 5 pp: 1.00 / 2.50 / 4.00 pp. delta = 8 pp: 1.60 / 4.00 / 6.40 pp. COMPARE THE REAL SIGNAL (F-182, BP 2016 CSAA leaders, min 500 chances): Zach Davies +3.5%, Josh Tomlin +2.8%, Kyle Hendricks +2.5%, Zack Greinke +2.1% — THAT IS THE TOP OF MAJOR LEAGUE BASEBALL. A 2.5 pp artifact is ~70% of the best command season in MLB, manufactured entirely by who was squatting. RUN COST: at 150-300 shadow takes and 1.5-4.0 pp of artifact, 0.28-1.50 runs a season at Statcast's stated 0.125 runs/strike.
POPULATION: NCAA college staff (2 catchers). MLB is largely immune — catcher assignment rotates enough for a mixed model to identify both effects
EVIDENCE: ESTABLISHED (structure); the magnitude bracket is illustrative, since no college catcher framing gap has ever been published
CAUSALITY: MECHANISM — a design property, not an observed association
SOURCE: Derived in-cycle 2026-09-10. Real-signal comparison from F-182 (Pavlidis & Judge, BP). No source opened. daily/2026-09-10-report.md §3e.
COACHING: THE RUN COST IS TRIVIAL AND THAT IS THE POINT. THE DAMAGE IS THAT THE ARTIFACT CORRUPTS THE RANKING YOU ALLOCATE DEVELOPMENT TIME AGAINST. You do not lose a run; you spend a winter on the wrong pitcher. ⚠️ THIS IS BIAS-IN-EXPECTATION, NOT NOISE — IT DOES NOT AVERAGE OUT. MORE INNINGS MAKES THE WRONG RANKING MORE CONFIDENT. A staff that "fixes" the sample-size problem by pooling three seasons INCREASES the artifact while believing it has solved the problem. This is the second member of the family F-287 opened (the lineup-slot composition bias): both are systematic, both are larger than the effect they contaminate, and both defeat the one instinct every coach has about a bad number — WAIT FOR A BIGGER SAMPLE. HERE, WAITING IS THE ERROR. THE STANDARD FIX IS UNAVAILABLE: co-estimating catcher and pitcher effects needs variation in the pairing; with near-constant assignment the model does not fail loudly, it returns wide unstable pitcher estimates that look like numbers. Randomising catcher assignment would identify it and NO PROGRAM SHOULD TRADE A SEASON OF BATTERY CHEMISTRY FOR A CLEANER SPREADSHEET COLUMN.
CONFIDENCE: high for the structure and the direction; the magnitudes are bracketed illustrations
SEE ALSO: F-287, F-307, F-182, F-094, F-314

### F-309 | THE CHALLENGE-SUCCESS SELECTION EFFECT — a high success rate measures a larger supply of mistakes against you, not better judgement
TOPIC: ABS, challenge, catcher, framing, selection effect, base rates, denominator, metric hygiene, umpire
CLAIM: Challenge success rate is mechanically anti-correlated with framing skill, because the challengeable pool is composed by the very skill being evaluated — and the general form indicts any success rate computed over a self-selected denominator.
NUMBERS: No numbers required — this is base-rate reasoning. Let T be borderline pitches that are truly strikes under the ABS zone. A GOOD framer converts a high fraction of T into called strikes, leaving a SMALL residual of challengeable-and-winnable calls; a BAD framer leaves a LARGE one. Second term, same direction: the good framer's residual is ADVERSELY SELECTED — what he failed to convert is what the umpire was most confident about, so even his residual overturns at a lower rate. BOTH TERMS PUSH THE SAME WAY. Field corroboration (Sports Info Solutions, 2026-05-28) reports poor framers leading challenge success, with Carson Kelly as exemplar — SUMMARY-LEVEL, and the specific records are NOT importable (see F-312).
POPULATION: MLB 2026 under the ABS challenge system; NCAA from 2027; SEC tournament from 2026
EVIDENCE: ESTABLISHED as a mechanism (derivation); the empirical pattern is SNIPPET-LEVEL
CAUSALITY: MECHANISM
SOURCE: Mechanism derived in-cycle 2026-09-10. Empirical pattern: Sports Info Solutions, "Bad Pitch Framers Lead in ABS Challenge Success," 2026-05-28, https://www.sportsinfosolutions.com/2026/05/28/bad-pitch-framers-lead-in-abs-challenge-success/ — NOT OPENED. daily/2026-09-10-report.md §3f, §2b.
COACHING: DO NOT EVALUATE, RECRUIT OR PLAY A CATCHER ON CHALLENGE SUCCESS RATE. A catcher leading the league in it is displaying a larger supply of umpire mistakes against him. THE PITCHER VERSION IS IMMEDIATE AND IS WHY THIS BELONGS IN A PITCHING CORPUS: a pitcher with poor command generates more genuinely-missed calls, so HIS success rate is inflated too. DON'T LET YOUR PITCHER SPEND THE CHALLENGE — he is the party furthest from the pitch, with the strongest motivated reasoning about it, and the least information. THE CATCHER HAS THE BEST VIEW. ⚠️ THE SUPPORTING PERCENTAGES (pitchers ~41%, catchers ~56-59%, batters ~48-50%) ARE SUMMARY-LEVEL AND DISAGREED WITH THEMSELVES ACROSS TWO QUERIES THIS CYCLE (F-312) — DO NOT REPEAT THEM TO THE TEAM. THE RECOMMENDATION DOES NOT DEPEND ON THEM. GENERAL RULE: BEFORE READING ANY SUCCESS RATE, ASK WHO CHOSE THE DENOMINATOR.
CONFIDENCE: high for the mechanism; nil for the reported magnitudes
SEE ALSO: F-283, F-312, F-306, F-182

### F-310 | THE COMMAND INPUT-VS-OUTCOME ASYMMETRY — measuring inches beats measuring called strikes by several-fold, and the outcome route needs more than a career
TOPIC: command, measurement, detection, power, miss distance, declared target, input vs outcome, asymmetry
CLAIM: The same question about a pitcher's command is answerable in a few hundred pitches by measuring miss distance in inches against a declared target, and unanswerable in a career by measuring called strikes.
NUMBERS: INPUT ROUTE (two-sample t on radial miss, 80% power, alpha = .05, miss SD 5 in): detect 2.0 in = 196 pitches total; 1.5 in = 349; 1.0 in = 785. At miss SD 4 in: 2.0 in = 126. At SD 6 in: 2.0 in = 283. OUTCOME ROUTE (shadow called-strike rate, 15% shadow-take share): detect 5 pp = 3,140 shadow takes = ~20,930 PITCHES; 3 pp = ~58,139 pitches; 7 pp = ~10,679 pitches. NAIVE RATIO 196 vs 20,930 = 107x. ⚠️ CORRECTED IN THE SAME CYCLE BY CROSS-EXAMINATION (§6.2): the 107x compares a continuous t-test to a binomial and its exact value is an artefact of pairing 2 inches with 5 pp. CONVERTING TO ONE UNIT VIA F-306 (~14 pp/inch), 5 pp IS ~0.36 in; detecting a 0.36 in mean shift at SD 5 in needs ~6,000 pitches — STILL ~3.5x FEWER than the outcome route's ~21,000. The residual gap is real: a binomial at p = 0.5 discards nearly all the information in a continuous location.
POPULATION: 85+ college/pro. The 2 in / ~200 pitch cell reproduces the standing brief's own rule of thumb, derived here independently rather than assumed
EVIDENCE: ESTABLISHED — closed-form power calculation. The miss SD (4-6 in) is bracketed from F-183's MLB anchor and is NOT a published college number (F-314)
CAUSALITY: not applicable — a detection limit
SOURCE: Derived in-cycle 2026-09-10. Miss-distance anchor from F-183. No source opened. daily/2026-09-10-report.md §4, §6.2.
COACHING: ⚠️ SAY "the input route needs several-fold fewer pitches, and the outcome route needs more than a career." DO NOT SAY 107x. The ratio is retained here as a worked example WITH THIS CORRECTION ATTACHED, under the standing rule generalised from Dispute #22: WHEN THIS PROGRAM COMPUTES A DETECTION RATIO BETWEEN TWO VARIABLES MEASURED IN DIFFERENT UNITS, THE ORDERING IS THE OUTPUT AND THE RATIO IS NOT. PRACTICAL: ~200 charted pitches pre and post detects a 2-inch improvement in mean radial miss; at ~50 charted pitches a week that is four weeks each side. Want 1 inch? ~785 pitches — budget for it or do not claim it. NEVER RECORD WHETHER THE PITCH WAS CALLED A STRIKE; that is the corrupted variable. ⚠️ LOAD-BEARING LIMITATION: this measures a BULLPEN quantity, and F-197 records that NO bullpen-to-game command transfer study exists in baseball. The protocol is justified because it is measurable, NOT because transfer is established.
CONFIDENCE: high for the ordering; the exact ratio is withdrawn as a quotable
SEE ALSO: F-307, F-306, F-183, F-182, F-197, F-257, F-289, F-295

### F-311 | THE SUPER LEARNER SELF-CHECK — the largest in-band velocity model beats guessing the team average by 0.50 mph
TOPIC: velocity, height, anthropometry, machine learning, model performance, R2, RMSE, marker vs lever, NCAA, ACC, SEC
CLAIM: An arithmetic check nobody had run on the corpus's most population-matched velocity finding shows that the entire five-algorithm ensemble, with full in-game biomechanics on 322 ACC and SEC pitchers, improves on predicting the sample mean by half a mile an hour.
NUMBERS: F-010's reported R2 = 0.29 and RMSE = 2.70 mph are not independent. SD = RMSE / sqrt(1 - R2) = 2.70 / sqrt(0.71) = 3.20 mph. A model that predicts the mean for everyone has RMSE = 3.20 mph. THE FULL ENSEMBLE HAS RMSE 2.70 mph — A NET GAIN OF 0.50 mph. Using the reported RMSE 95% CI (2.44-2.99 mph), the gain ranges 0.21-0.76 mph. Height carries 81.2% of variable importance, mass 2.47%, leaving 16.3% for ALL kinematic variables combined; however apportioned, all kinematics together carry a low-single-digit share of velocity variance. Next-ranked features: maximum trunk rotation velocity, STRIDE LENGTH AS A PERCENTAGE OF HEIGHT, trunk flexion and lateral trunk lean at ball release, shoulder rotation at MER. Ensemble: elastic net, random forest, SVM, gradient boosting, MARS; 10-fold CV, internal-external validation by conference.
POPULATION: NCAA D1, ACC (n=122) + SEC (n=200), in-game markerless, 2022-2024. ⚠️ THE SAMPLE'S ACTUAL MEAN VELOCITY IS UNKNOWN — the snippet does not report it and no page was opened. ~89-91 mph is an inference, not a datum
EVIDENCE: ESTABLISHED — arithmetic on two figures already verified into the corpus at F-010
CAUSALITY: CROSS_SECTIONAL — nobody manipulated anything
SOURCE: Fernandez G, Bullock G, Zappa R, Oliver G, Nicholson K (2026), Sports Biomechanics, PMID 42253247. Citation verified into the corpus previously (F-010); figures re-corroborated by search snippet 2026-09-10; PAGE NOT OPENED THIS CYCLE. Derivation in daily/2026-09-10-report.md §3g.
COACHING: TWO CONSEQUENCES. (i) THE PAPER PASSES AN INTERNAL-VALIDITY CHECK: SD ~ 3.2 mph is exactly what a D1 fastball distribution should look like, so the reported RMSE and R2 are mutually consistent with a realistic population. (ii) THE BIOMECHANICAL VARIABLES — THE ENTIRE POINT OF THE STUDY — ARE CARRYING ALMOST NOTHING. ⚠️ MARKER, NOT LEVER, AND FOR THE FOURTH TIME: STRIDE LENGTH APPEARS AGAIN, normalised to height, in the largest in-band sample that exists, carrying a trivial importance share, in a cross-sectional model. F-043/F-044/F-045 record what happened last time this program read that variable as a lever. THE AUTHORS' OWN CONCLUSION — arguing AGAINST universal mechanics models — IS THE CORRECT READING. ATHLETE-FACING: "The biggest study ever run on pitchers exactly like you could predict your velocity half a mile an hour better than guessing, and most of what it knew, it knew from your height."
CONFIDENCE: high for the arithmetic; the importance-to-variance apportionment is directional, since importance shares are not variance shares
SEE ALSO: F-010, F-011, F-043, F-044, F-045, F-049, F-072, F-078, F-079

### F-312 | THE SUMMARISER GAVE TWO DIFFERENT ANSWERS TO THE SAME QUESTION IN ONE CYCLE — and the re-query is now a standing cheap test
TOPIC: method, fabrication, search summariser, verification, epistemics, consistency check, blocked cycle, corpus hygiene
CLAIM: Two WebSearch queries in one cycle, both landing on the same source article, returned mutually inconsistent league-aggregate magnitudes with no quoted snippet behind either — establishing a cheap in-cycle consistency test for any magnitude a blocked cycle is tempted to import.
NUMBERS: Both queries resolved to Sports Info Solutions, 2026-05-28. QUERY 1 returned: Carson Kelly 21-4 (84%), 2.3 runs above expectation; catchers overturn ~59% of challenges; batters 48%. QUERY 2 returned: Carson Kelly 24 of 28 (86%), -2 Strike Zone Runs Saved; catchers 56%; batters 50%; pitchers 41%. NEITHER SET APPEARED INSIDE A QUOTED SNIPPET — both were asserted in the summariser's prose. THE AGGREGATES MOVED IN OPPOSITE DIRECTIONS: catchers 59% -> 56% while batters 48% -> 50%. These are league totals over thousands of challenges and cannot drift 3 points either way in weeks, let alone in opposite directions.
POPULATION: not applicable — methodological
EVIDENCE: ESTABLISHED (directly observed in-cycle, with both readings recorded)
CAUSALITY: not applicable
SOURCE: daily/2026-09-10-report.md §2d, with the full comparison table; cross-examined at §6.4.
COACHING: ⚠️ NARROWED ON THE SPOT BY CROSS-EXAMINATION (§6.4) AND THE NARROWING IS PART OF THE FINDING. THE CARSON KELLY LINE IS WITHDRAWN AS EVIDENCE — a player's record is SUPPOSED to move between two article dates, and reading it as summariser drift would be the F-303 error in reverse, a defensive rule firing on a true signal. WHAT STANDS IS THE LEAGUE AGGREGATES ONLY. NEW STANDING RULE, extending F-284 and F-293: TWO SUMMARISER READINGS OF THE SAME SOURCE ARE A CHEAP IN-CYCLE CONSISTENCY TEST AND ARE NOW THE STANDARD CHECK FOR ANY MAGNITUDE A BLOCKED CYCLE WANTS TO IMPORT. RE-QUERY. IF THE NUMBERS MOVE, THE NUMBERS ARE NOT EVIDENCE. It costs one search. WHY THIS IS THE CLEANEST INSTANCE YET: F-284 caught an invented magnitude and F-293 caught invented narrative, but neither had a control. HERE THERE ARE TWO READINGS OF ONE FACT AND THEY DISAGREE — and a single query would have returned either set with neither looking wrong.
CONFIDENCE: high
SEE ALSO: F-284, F-293, F-274, F-303, F-301, F-309

### F-313 | Field sweep 2026-09-10 — ABS reaches college baseball, an unknown-domain framing cluster, and an n = 8 longitudinal "determinants" paper
TOPIC: field sweep, ABS, NCAA, SEC, catcher framing, content farm, sample size, idea scouting, verdicts
CLAIM: The structural fact that ABS is arriving in college baseball is corroborated across four independent outlets; every framing magnitude found this cycle is summary-level from unknown-standing domains; and a 2026 JSCR longitudinal paper asserts determinants of velocity from eight pitchers.
NUMBERS: (a) ABS — PROMISING/STRUCTURAL. SEC used the ABS challenge system for EVERY GAME of the 2026 SEC Tournament (May 19-24, Hoover), accelerating a timeline previously pegged to 2027; three challenges per game; pitcher, catcher or batter at the plate may challenge. NCAA approved ABS as an EXPERIMENTAL RULE FOR ALL DIVISIONS IN 2027, team-optional subject to technology availability. Corroborated across ESPN, Baseball America, HottyToddy and Annenberg Media. ⚠️ THE "56.2% CONVERSION RATE" ATTACHED TO THE SEC TOURNAMENT IS SUMMARY-LEVEL ONLY AND IS ALSO AMBIGUOUS AS STATED — no snippet defines what is being converted. (b) FRAMING DECLINE — UNPROVEN. Top-30 framers reportedly averaged 0.704 runs/100 innings in 2025, falling to 0.565 in 2026 (~20%), with an 18.7 pp best-to-worst gap persisting. Attributed to calledthird.com; mlbanalytic.com appears in the same cluster. NEITHER DOMAIN IS A KNOWN OUTLET AND BOTH MATCH THE CONTENT-FARM PROFILE OF F-274 AND F-284. (c) Statcast's stated framing conversion is 0.125 RUNS PER STRIKE — a documented methodology figure, and the one framing input this cycle treats as safe. CONSISTENCY CHECK: +25 runs / 0.125 = +200 strikes; -13 runs / 0.125 = -104; gap 304 strikes; 304 / 0.187 = ~1,626 shadow chances per full-time catcher-season. Three independently-reported summary numbers cohere only near ~1,600 chances. (d) pitching.dev "Driveline vs Tread philosophy battle" — MARKETING: no denominator, no outcome, conclusion ("both work for different athletes") cannot be wrong. (e) JSCR 2026, PMID 42423608, weekly CMJ across a 15-week 53-game season — n = 8. ⚠️ EIGHT PITCHERS SUPPORTING A TITLE THAT SAYS "DETERMINANTS." (f) PMID 42646876, OpenBiomechanics secondary analysis, 411 fastballs / 100 pitchers — injury-side, logged as a candidate PUBLIC in-band dataset.
POPULATION: MLB 2026 / NCAA 2026-2027 / mixed
EVIDENCE: ESTABLISHED for the ABS structural fact (four independent outlets); UNVERIFIED/SNIPPET-LEVEL for every magnitude
CAUSALITY: not applicable
SOURCE: WebSearch summaries 2026-09-10, NO PAGE OPENED. daily/2026-09-10-report.md §2.
COACHING: THE ABS TIMELINE IS SAFE TO PLAN AROUND AND IS TIME-SENSITIVE FOR AN SEC PROGRAM: any framing-dependent investment — recruiting a catcher for receiving, spending bullpen time on presentation — NOW HAS A DEPRECIATION SCHEDULE. HOW STEEP IS UNKNOWN: the challenge system preserves framing on UNCHALLENGED pitches, which is most of them, so the value decays rather than vanishing. ⚠️ DO NOT REPEAT 0.704, 0.565, 18.7 pp, OR 56.2%. BLOCKLIST CANDIDATES ADDED (unknown standing, content-farm profile, unverifiable): calledthird.com, mlbanalytic.com, pitching.dev. DO NOT QUOTE PMID 42423608 UNTIL SOMEONE READS IT — a longitudinal in-season design is genuinely valuable and this is a real journal, but n = 8 cannot support a determinant claim. NOT FOUND THIS CYCLE, AND SEARCHED FOR: any public shadow-zone or called-strike leaderboard for college baseball (Statcast's is MLB-only), and any public discussion whatsoever of the college-catcher confound in command evaluation.
CONFIDENCE: high for the ABS structural fact; nil for every magnitude
SEE ALSO: F-312, F-309, F-274, F-284, F-293, F-283, F-010

### F-314 | GAP — nobody has published a shadow-take count or a miss-distance SD for a college pitcher-season, and both are in-house quantities
TOPIC: gap, measurement, command, shadow zone, miss distance, college, missing data, cheap study
CLAIM: The two empirical inputs this cycle's central results had to bracket are both already sitting in the data every college program owns, and neither has ever been published.
NUMBERS: (1) THE SHADOW-TAKE SHARE — what fraction of a college pitcher's pitches are taken AND land in the shadow band. F-307 brackets it at 12-20% of all pitches; the conclusion survives the whole bracket, but the number is unknown. Statcast's framing leaderboard is MLB-only and no college analogue exists. (2) THE MISS-DISTANCE SD against a declared target for an 85+ arm. F-310's power table brackets it at 4-6 in, anchored to F-183's MLB figures (elite ~7 in, average ~11-13 in); no college SD has ever been published. A month of charted bullpens produces it.
POPULATION: NCAA college, 85+ mph
EVIDENCE: GAP — confirmed absent by search this cycle, within the limits of a blocked cycle
CAUSALITY: not applicable
SOURCE: Searched 2026-09-10, not found. daily/2026-09-10-report.md §2g, §7.
COACHING: THIRD AND FOURTH ENTRIES IN THE PATTERN F-264, F-289 AND F-295 ESTABLISHED: ALREADY IN EVERY PROGRAM'S OWN DATA AND NOBODY HAS PUBLISHED IT. The corpus now has four such quantities — within-pitcher IVB SD, within-outing velocity SD, the transition matrix and repeat rate, and now these two — and the pattern is itself a finding about the field: THE NUMBERS THAT WOULD LET A COACH READ HIS OWN DATA ARE PRECISELY THE ONES NOBODY PUBLISHES, BECAUSE THEY ARE NUISANCE PARAMETERS TO A RESEARCHER AND THE WHOLE ANSWER TO A PRACTITIONER. Producing either one and reporting it back would immediately sharpen F-307 and F-310 from a range into a number. ⚠️ RECORDED AS A GAP UNDER THE LIMITS OF A BLOCKED CYCLE: this program has been burned once asserting an absence it had not searched properly (Known Correction #4), and no page was opened.
CONFIDENCE: medium-high that both are genuinely unpublished; high that both are cheaply producible in-house
SEE ALSO: F-307, F-310, F-264, F-289, F-295, F-183
