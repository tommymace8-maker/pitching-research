...
**Compiled 2026-08-17. Updated 2026-09-08.** Companion to [`FINDINGS.md`](FINDINGS.md), the flat registry of **293** findings (F-285→F-293 added 2026-09-08, arithmetic plus one citation correction; F-277→F-284 added 2026-09-07, all source-independent arithmetic; F-268→F-276 added 2026-09-06; F-260→F-266 added 2026-09-05; F-251→F-259 added 2026-09-04; **F-255, F-256 and F-258 are UNVERIFIED leads in quarantine — see §7**).

> ### 🚨 EGRESS HAS NOW FAILED **FIVE TIMES IN A ROW** (2026-09-04, -05, -06, -07, -08)
> **Zero primary sources opened across five consecutive cycles.** `WebSearch` works; `WebFetch` and raw `curl` do not. On 2026-09-07 **and again on 2026-09-08** the proxy logged `403 to CONNECT — policy denial` for **every** host including **`en.wikipedia.org` used as a control**. **This is an empty network allowlist in the remote execution environment. It is not an outage, not a paywall, and not a proxy fault — IT REQUIRES A HUMAN TO CHANGE** (F-277, F-285).
> **The standing brief's WORKING-domain list has been wrong five times and should be DELETED from the prompt, not amended.**
> **PROBE EGRESS BEFORE CHOOSING A TOPIC.** This instruction was added after cycle 4, was followed on 2026-09-08, cost ninety seconds and determined the whole shape of the cycle. **KEEP IT.** If egress is down, pick a gap that arithmetic can close (F-266, F-278, F-286).
> **⚠️ THE UNREAD VERIFICATION QUEUE NOW STANDS AT 17 ITEMS. Five consecutive arithmetic-only cycles have produced ~40 findings, essentially all internally consistent and NONE checked against data.** That is the condition F-259 warns about, and the corpus is now deep enough into it that **the next cycle with working egress should spend itself entirely on the queue rather than opening a new topic.** Queue head: the Brill/Deshpande/Wyner TTOP paper (F-290, F-292).
...
**Total corpus:** ~7,800 lines of research across **12** library files, **9** daily briefs, and one structured citation module. **293 registered findings.**
...
### What is CONTESTED — the twenty open disputes
...
- **Seven research days exist** (2026-08-12, 2026-08-13, 2026-08-20 verification pass, 2026-09-04, 2026-09-05, 2026-09-06, 2026-09-07). Most of the corpus is still only two cycles deep.
